  ...
  return (
    <div className="sm:text-sm text-xs">
      {aiModel === "Gemini" || aiModel === "VISUAL-AI" ? (
        <div
          className="sticky border theme-border lg:mx-0 mx-2 h-auto theme-bg-comp rounded-xl focus-within:ring-[1px] "
          tabIndex="0"
        >
        ...
        >
          <h2 className="theme-bg-comp  px-4 py-2 rounded-lg shadow-lg">
            This AI model is currently unavailable
          </h2>
        </motion.div>
      )}
    </div>
